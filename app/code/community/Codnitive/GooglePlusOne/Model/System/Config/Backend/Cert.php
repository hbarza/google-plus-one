...
class Codnitive_GooglePlusOne_Model_System_Config_Backend_Cert extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        ...
        if ($value) {
            try {
                ...
                if ($condition) {
                    $err = Mage::helper('googleplusone')->__('%s extension not registered.', 
                            Mage::helper('googleplusone')->__(Codnitive_GooglePlusOne_Model_Config::EXTENSION_NAME));
